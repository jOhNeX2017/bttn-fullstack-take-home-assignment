...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('playlist_id',models.ForeignKey(to='api.Playlist', on_delete=django.db.models.deletion.CASCADE,related_name='playlist')),
                ('track_id',models.ForeignKey(to='api.Track', on_delete=django.db.models.deletion.CASCADE, related_name='track'))
            ],
        ),
    ]
